...
# Sampling sizes (requested: 1,000,000 main sample)
LOCAL_MAIN_SAMPLE = CACHE_DIR / "main_sample_1m.parquet"
...
def load_main_sample(sample_rows: int = 1_000_000, seed: int = 42) -> pd.DataFrame:
...
loading = _show_loading_overlay(
    ...
    f"Dataset: {HF_DATASET_ID} | Building cached samples (1,000,000 for charts; 60,000 for maps).",
)
try:
    # Requested: main sample = 1,000,000
...
"""
    ...
    st.write("Main sample target rows:", "1,000,000")
